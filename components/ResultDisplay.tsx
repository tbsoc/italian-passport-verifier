...
export default function ResultDisplay({ isVerified, isItalian, nationality, isLoading }: ResultDisplayProps) {
  if (isLoading) {
    return (
      <div className="text-center p-6">
        ...
        <p className="text-lg font-medium text-gray-700">Verifying your Italian heritage...</p>
  ...
  if (nationality) {
    if (isItalian) {
      ...
      return (
        <div className="text-center p-6 pizza-celebration">
          <div className="text-8xl mb-4">🍕</div>
          <h2 className="text-3xl font-bold text-italian-green mb-2">
      ...
      return (
        <div className="text-center p-6">
          ...
          <h2 className="text-2xl font-bold text-italian-red mb-2">
